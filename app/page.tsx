              ...
              <div className="flex flex-col justify-center items-end h-full">
                <div className="flex justify-end lg:justify-between w-full max-w-[800px] overflow-hidden pl-20">
                  <span className="w-[380px] hidden mx-auto xl:mx-0 h-fit my-auto sm:block text-sm sm:text-base">
                    <p>Hey there! I&apos;m Igbanibo Dengimo-owei Alex, but you can call me Dengi. I&apos;m a front-end focused web developer, passionate about crafting beautiful, scalable, and responsive web designs. Whether I&apos;m working solo or as part of a team, I love bringing creative ideas to life on the web.</p>
                    <br />
