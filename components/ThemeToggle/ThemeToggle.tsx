      ...
      <div className="">
        <label className="toggle" htmlFor="switch">
          <input id="switch" className="input" type="checkbox"
            ...
            checked={theme === "light"} // Check if the current theme is dark
            onChange={toggleTheme}
          />
          <div className="icon icon--moon">
            <svg height="20" width="20" fill="#b5b3cb" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="icon icon--sun">
            <svg height="20" width="20" fill="black" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
